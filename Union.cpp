// Incluir las bibliotecas necesarias para el funcionamiento del programa
#include <iostream>
#include <string>
#include <map>
#include <set>
...
// Usar el espacio de nombres estándar para evitar tener que anteponer std:: antes de los elementos del estándar
using namespace std;

class Tarea {
public:
    // Definición de una estructura de datos global para mapear proyectos a tareas
    static map<string, set<string>> proyectosTareas;

    // Set para almacenar los responsables de cada tarea
    set<string> responsables;

    // Variables miembro para almacenar información sobre la tarea
    string nombreProyecto, nombreTarea, descripcion, estadoTarea, prioridadTarea, responsableTarea, fechaLimiteTarea;

    // Constructor predeterminado que inicializa las variables miembro con valores vacíos
    Tarea() {
        descripcion = "";
        nombreTarea = "";
        estadoTarea = "";
    ...
    // Constructor parametrizado para inicializar algunas variables miembro
    ...
    // Sobrecarga del operador < para comparar tareas por prioridad y nombre
    ...
    // Funciones miembro para interactuar con objetos de la clase Tarea
    void pedirDatos();
    void mostrarEstado();
    void cambiarEstado();
    void AsignarTareas();
...
// Instancia global del mapa de proyectos a tareas
...
bool ValidacionDeDatos(map<string, Tarea>& tareas){
    ...
    while (true) {
        cout << "Ahora por favor digite el número de la opción que desea elegir: " << endl;
        cout << "1. Crear nueva tarea\n2. Agregar responsables a tarea\n" << endl;
        cin >> decisionUsuario;
        cin.ignore();

        if (decisionUsuario == 1) {
            cout << "Escribe el nombre de la tarea que deseas crear: " << endl;
            cin >> nuevaTarea;
            // Crear una nueva tarea y agregarla al mapa tareas
...
// Función para asignar tareas a un proyecto específico
void AsignarTareas(string nombreProyecto) {
    cout << "Ahora, podrás agregar las tareas que desees a sus proyectos: " << endl;
    ...
    cout <<"Ingrese la fecha límite de la tarea: " << endl;
    cin.ignore();
...
map<string, string> estados = {
    ...
    {"lista-para-revision", "Lista Para Revisión"}
};

// Función para solicitar datos de entrada para una tarea
void Tarea::pedirDatos() {
    cout << "Por favor escriba el nombre del proyecto:" << endl;
    cin >> nombreProyecto;
    cout << "Por favor escriba el nombre de la Tarea:" << endl;
    cin >> nombreTarea;
    cout << "No olvides poner el guion en cada espacio del estado." << endl;
...
// Función para mostrar el estado actual de una tarea
...
void Tarea::cambiarEstado() {
    ...
    cout << "Estado cambió a: " << estados[estadoTarea] << endl;
}

// Función para mostrar las tareas de un conjunto de tareas
...
// Función para mostrar los responsables de un conjunto de responsables
void mostrarResponsables(const set<string>& responsables) {
    cout << "Los responsables ordenados alfabéticamente son:\n";
...
int main(){
    ...
    while (true) {
        ...
        cin >> opcion;
        switch(opcion){
            case 1: // Asignar responsables a tarea.
                map<string, Tarea> tareas;
                // Crear un mapa para almacenar las tareas y sus responsables
                bool continuar = true;
                while (continuar) {
                ...
                break;
            case 2: // Asignar tareas a proyectos.
                cout << "Por favor escribe el nombre del proyecto:" << endl;
                cin >> nombreProyecto;
                AsignarTareas(nombreProyecto);
                break;
            case 3: // Cambiar el estado de la tarea.
                int opcion;
                Tarea tarea;
                tarea.pedirDatos();
                tarea.mostrarEstado();
                cout << "¿Quieres cambiar el estado de la tarea? 1.SI2. NO. Responde en español. " << endl;
                cin >> opcion;
                if(opcion == 1){
                    tarea.cambiarEstado();
                } else{
                ...
                tarea.mostrarEstado();
                break;
            case 4: // Organizar tareas por prioridad.
                ...
                for (const auto& tarea : tareasPredefinidas) {
                    Tarea nuevaTarea;
                    nuevaTarea.nombreProyecto = nombreProjetos[nombreProyecto];
            ...
            case 5: // Que el usuario pueda salir de la aplicacion. 
                cout << "Saliendo..." << endl;
