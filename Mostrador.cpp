...
void Mostrador::mostrarProyectos(){
...
void Mostrador::mostrarTareasProyectos(string nombreProyecto){
...
string Mostrador::proyectosDisponibles(){
...
void Mostrador::mostrarResponsablesTarea(){
...
void Mostrador::imprimirTareasPorPrioridad() {
